...
export function setupDrawPetals(element: HTMLDivElement) {
  ...
  const drawPetals = (
    ...
    const polyline = document.querySelector<SVGPolylineElement>(
      `#${svgPolylineId}`,
    )!;
  ...
  const inputPetalNumber =
    document.querySelector<HTMLInputElement>("#petals-number")!;
  const inputPetalLength =
    document.querySelector<HTMLInputElement>("#petals-length")!;
